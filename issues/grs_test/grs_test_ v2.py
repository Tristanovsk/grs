...
cams_raster =cams.raster.rename({"x": "xc", "y": "yc"})
transmittance_raster = gas_trans.Tg_tot_coarse.drop_vars('pressure')
l2_prod['vza'] = prod.raster.vza.mean('wl')
l2_prod['sza'] = prod.raster.sza
l2_prod['raa'] = prod.raster.raa.mean('wl')
l2_prod = xr.merge([l2_prod,cams_raster,transmittance_raster])

#
complevel=5
ofile='test_grs_v2.nc'
encoding = {'Rrs': {'dtype': 'int16', 'scale_factor': 0.00001, 'add_offset': .3, '_FillValue': -32768,"zlib": True, "complevel": complevel},
            'Rrs_g': {'dtype': 'int16', 'scale_factor': 0.00001, 'add_offset': .3, '_FillValue': -32768,"zlib": True, "complevel": complevel},
            'aot550': {'dtype': 'int16', 'scale_factor': 0.001, '_FillValue': -9999,"zlib": True, "complevel": complevel},
            ...
            'aot550': {'dtype': 'int16', 'scale_factor': 0.001, '_FillValue': -9999,"zlib": True, "complevel": complevel},
            'BRDFg': {'dtype': 'int16', 'scale_factor': 0.00001, 'add_offset': .3, '_FillValue': -32768,"zlib": True, "complevel": complevel},
            }
l2_prod.to_netcdf(ofile, encoding=encoding)
l2_prod.close()
