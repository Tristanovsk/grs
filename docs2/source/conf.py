...
# are used.
fortran_src = [ os.path.abspath('../../grs/fortran/grs'),  ]
...
# documentation.
html_theme_options = {'page_width': '1200px', 'body_max_width': 'auto'}
...
latex_documents = [
    (master_doc, 'grs.tex', u'grs Documentation',
     u'Tristan Harmel', 'manual'),
]
...
man_pages = [
    (master_doc, 'grs', u'grs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'grs', u'grs Documentation',
     author, 'grs', 'One line description of project.',
     'Miscellaneous'),
]
